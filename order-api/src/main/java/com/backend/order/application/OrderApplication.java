...
import com.backend.order.client.UserClient;
import com.backend.order.client.user.ChangeBalanceForm;
import com.backend.order.client.user.CustomerDto;
...
import static com.backend.order.exception.ErrorCode.ORDER_FAIL_CHECK_CART;
import static com.backend.order.exception.ErrorCode.ORDER_FAIL_NO_MONEY;
...
//        Cart orderCart = cartApplication.getCart(customerId);
        ...
        for (Cart.Product product : orderCart.getProducts()) {
            for (Cart.ProductItem carttItem : product.getItems()) {
                ProductItem productItem = productItemService.getProductItem(carttItem.getId());
                productItem.setCount(productItem.getCount() - carttItem.getCount());
            }
        }
    }
